...
SELECT
*FROM property_Info 
WHERE Monthly_Repayment >25000 and PROVINCE = 'Gauteng';
...
SELECT
*FROM property_Info ORDER BY FLOOR_SIZE ASC;
...
SELECT
*FROM property_Info 
WHERE PROVINCE = 'KWAZULU NATAL' AND BEDROOMS >0

--QUESTION 14.. Find properties in Limpopo or Free State ordered by property price
SELECT
*FROM property_Info 
WHERE PROVINCE = 'LIMPOPO' OR PROVINCE='FREESTATE' ORDER BY PROPERTY_PRICE DESC
